<x-app-layout>
    <div class="w-full py-2 px-14">
        <h1 class="font-medium text-xl">Create A New Note</h1>
        <form action="{{route('note.store')}}" method="post">
            @csrf
            <div class="w-full pt-3">
                <textarea class="w-full rounded-lg border-[#777777] outline-none" placeholder="Type your note..." name="note" rows="10"></textarea>
            </div>
